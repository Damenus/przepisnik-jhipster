...
import pl.przepisnik.config.audit.AuditEventConverter;
import pl.przepisnik.domain.PersistentAuditEvent;
...
import static pl.przepisnik.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
