...
export class IngredientComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.ingredientService.search({
                ...
                (res: HttpResponse<Ingredient[]>) => this.onSuccess(res.body, res.headers),
    ...
    registerChangeInIngredients() {
        this.eventSubscriber = this.eventManager.subscribe('ingredientListModification', (response) => this.reset());
    }
